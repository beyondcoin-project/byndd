...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr byndutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*byndutil.Tx, error) {
...
func CreateBlock(prevBlock *byndutil.Block, inclusionTxs []*byndutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr byndutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*byndutil.Block, error) {
	...
	blockTxns := []*byndutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := byndutil.NewBlock(&block)
