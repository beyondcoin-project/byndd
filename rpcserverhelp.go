...
var helpDescsEnUS = map[string]string{
	...
	"sendrawtransaction-maxfeerate":    "Used by beyondcoind on or after v0.19.0",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown byndd.",
	"stop--result0":  "The string 'byndd stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this byndd instance) and when such a transaction first appears in a newly-attached block.",
