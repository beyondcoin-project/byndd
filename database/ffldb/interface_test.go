...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*byndutil.Block, error) {
	...
	blocks := make([]*byndutil.Block, 0, 256)
	genesis := byndutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
