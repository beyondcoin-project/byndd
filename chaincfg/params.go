...
var (
	...
	// mainPowLimit is the highest proof of work value a Beyondcoin block can
	...
	// regressionPowLimit is the highest proof of work value a Beyondcoin block
	// can have for the regression test network.  It is the value 2^255 - 1.
	regressionPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 255), bigOne)

	// testNet3PowLimit is the highest proof of work value a Beyondcoin block
	// can have for the test network (version 3).  It is the value
	// 2^224 - 1.
	testNet3PowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNet4PowLimit is the highest proof of work value a Beyondcoin block
	...
	// simNetPowLimit is the highest proof of work value a Beyondcoin block
...
// Params defines a Beyondcoin network by its parameters.  These parameters may be
// used by Beyondcoin applications to differentiate networks as well as addresses
...
// MainNetParams defines the network parameters for the main Beyondcoin network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9333",
	DNSSeeds: []DNSSeed{
		{"seed-a.beyondcoin.loshan.co.uk", true},
		{"dnsseed.thrasher.io", true},
		{"dnsseed.beyondcointools.com", false},
		{"dnsseed.beyondcoinpool.org", false},
	...
	// BIP 173.
	Bech32HRPSegwit: "bynd", // always bynd for main net
...
// Beyondcoin network.  Not to be confused with the test Beyondcoin network (version
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "rbynd", // always rbynd for reg test net
...
// TestNet4Params defines the network parameters for the test Beyondcoin network
...
var TestNet4Params = Params{
	...
	DefaultPort: "19335",
	DNSSeeds: []DNSSeed{
		{"testnet-seed.beyondcointools.com", false},
		{"seed-b.beyondcoin.loshan.co.uk", true},
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "tbynd", // always tbynd for test net
...
// SimNetParams defines the network parameters for the simulation test Beyondcoin
...
var SimNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "sbynd", // always lsb for sim net
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Beyondcoin
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Beyondcoin network")
...
// Register registers the network parameters for a Beyondcoin network.  This may
