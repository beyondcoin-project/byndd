...
/*
byndd is a full-node Beyondcoin implementation written in Go.

The default options are sane for most users.  This means byndd will work 'out of
...
parsed when byndd starts up.  By default, the configuration file is located at
~/.byndd/byndd.conf on POSIX-style operating systems and %LOCALAPPDATA%\byndd\byndd.conf
...
Application Options:
  ...
  -d, --debuglevel=           Logging level for all subsystems {trace, debug,
      ...
      --generate              Generate (mine) beyondcoins using the CPU
      ...
      --miningaddr=           Add the specified payment address to the list of
                              ...
                              set
      --minrelaytxfee=        The minimum transaction fee in BYND/kB to be
      ...
      --rpcmaxwebsockets=     Max number of RPC websocket connections (default:
                              25)
      --rpcquirks             Mirror some JSON-RPC quirks of Beyondcoin Core --
