...
reason, the byndd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire byndd
...
One of the major design goals of all core byndd packages is to aim for complete
...
commits](https://github.com/byndsuite/byndd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into byndd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/byndsuite/byndd/graphs/contributors)!
...
[ISC license](https://github.com/byndsuite/byndd/blob/master/LICENSE).  This is
the same license as all of the code in the byndd suite.
