...
5. [How do I use bootstrap.dat with byndd?](#Importing)
...
### 5. How do I use bootstrap.dat with byndd?

byndd comes with a separate utility named `addblock` which can be used to import
...
1. Stop byndd if it is already running.  This is required since addblock needs to
   access the database used by byndd and it will be locked if byndd is using it.
