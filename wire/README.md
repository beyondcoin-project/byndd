...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/byndsuite/byndd/wire)
=======
...
[here](https://blog.conformal.com/btcwire-the-bitcoin-wire-protocol-package-from-byndd/).
...
```bash
$ go get -u github.com/byndsuite/byndd/wire
```
