...
import (
	...
	peerpkg "github.com/byndsuite/byndd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*byndutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *byndutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *byndutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *byndutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
