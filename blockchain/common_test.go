...
// byndutil.Block.  This is largely borrowed from the test code in bynddb.
func loadBlocks(filename string) (blocks []*byndutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = byndutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
