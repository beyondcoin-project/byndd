...
func (view *UtxoViewpoint) AddTxOut(tx *byndutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *byndutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *byndutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *byndutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *byndutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *byndutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *byndutil.Tx) (*UtxoViewpoint, error) {
