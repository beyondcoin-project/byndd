...
func dbAddTxIndexEntries(dbTx database.Tx, block *byndutil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *byndutil.Block) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block *byndutil.Block,
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block *byndutil.Block,
	stxos []blockchain.SpentTxOut) error {
