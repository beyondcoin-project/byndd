...
import (
	...
	"github.com/byndsuite/byndutil/gcs"
	"github.com/byndsuite/byndutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *byndutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *byndutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *byndutil.Block,
