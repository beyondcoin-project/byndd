...
func GetBlockWeight(blk *byndutil.Block) int64 {
...
func GetTransactionWeight(tx *byndutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *byndutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
