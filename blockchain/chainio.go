...
func (b *BlockChain) FetchSpendJournal(targetBlock *byndutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *byndutil.Block) ([]SpentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := byndutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err = b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(byndutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a byndutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*byndutil.Block, error) {
	...
	block, err := byndutil.NewBlockFromBytes(blockBytes)
	if err != nil {
		return nil, err
	}
...
func dbStoreBlock(dbTx database.Tx, block *byndutil.Block) error {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*byndutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*byndutil.Block, error) {
