...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*byndutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *byndutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *byndutil.Block) error {
