...
(http://godoc.org/github.com/byndsuite/byndd/peer)
...
```bash
$ go get -u github.com/byndsuite/byndd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/byndsuite/byndd/peer#example-package--NewOutboundPeer)  
