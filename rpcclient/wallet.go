...
import (
	...
	"github.com/byndsuite/byndd/btcjson"
	"github.com/byndsuite/byndd/chaincfg"
	"github.com/byndsuite/byndd/chaincfg/chainhash"
	"github.com/byndsuite/byndd/wire"
	"github.com/byndsuite/byndutil"
)
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []byndutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []byndutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee byndutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee byndutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address byndutil.Address, amount byndutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address byndutil.Address, amount byndutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address byndutil.Address,
	amount byndutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address byndutil.Address, amount byndutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress byndutil.Address, amount byndutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress byndutil.Address, amount byndutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress byndutil.Address, amount byndutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress byndutil.Address, amount byndutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress byndutil.Address, amount byndutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress byndutil.Address,
	amount byndutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[byndutil.Address]byndutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[byndutil.Address]byndutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[byndutil.Address]byndutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[byndutil.Address]byndutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (byndutil.Address, error) {
	...
	return byndutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []byndutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []byndutil.Address, account string) (byndutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []byndutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []byndutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (byndutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (byndutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (byndutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (byndutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (byndutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (byndutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (byndutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (byndutil.Address, error) {
...
func (c *Client) GetAccountAsync(address byndutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address byndutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address byndutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address byndutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]byndutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]byndutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = byndutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]byndutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount byndutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount byndutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount byndutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount byndutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount byndutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount byndutil.Amount,
...
func (c *Client) ValidateAddressAsync(address byndutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address byndutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]byndutil.Amount)
	for k, v := range accounts {
		amount, err := byndutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]byndutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]byndutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := byndutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (byndutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (byndutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (byndutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (byndutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (byndutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (byndutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address byndutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address byndutil.Address) (byndutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address byndutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address byndutil.Address, minConfirms int) (byndutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address byndutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address byndutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address byndutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address byndutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*byndutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return byndutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address byndutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address byndutil.Address) (*byndutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *byndutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *byndutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *byndutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *byndutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *byndutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *byndutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a byndd chain server
