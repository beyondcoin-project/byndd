...
const (
	...
	defaultMaxFeeRate = byndutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*byndutil.Tx, error) {
	...
	return byndutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*byndutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[byndutil.Address]byndutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[byndutil.Address]byndutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address byndutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address byndutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address byndutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address byndutil.Address, skip,
