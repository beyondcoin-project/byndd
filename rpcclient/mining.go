...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address byndutil.Address, maxTries *int64) FutureGenerateToAddressResult {
...
func (c *Client) GenerateToAddress(numBlocks int64, address byndutil.Address, maxTries *int64) ([]*chainhash.Hash, error) {
...
func (c *Client) SubmitBlockAsync(block *byndutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *byndutil.Block, options *btcjson.SubmitBlockOptions) error {
